...
taxonomy <-read.delim("/home/kimberly.ledger/BeringSea_Arctic_eDNA/data/NBS_SBS_DBO_20240703/blastn_taxlineage_98.txt", header = FALSE, na.strings=c(""," ","NA"))
...
## going with a 0.5% similarity threshold
```{r}
...
# Define the input and output file paths
fasta_file <- "/home/kimberly.ledger/BeringSea_Arctic_eDNA/data/NBS_SBS_DBO_20240703/filtered.seqs.fasta"
output_file <- "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/oncorhynchus.fasta"
...
```{r}
write.csv(tax_df_5, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/taxonomy_20240725_uncollapsed.csv")
write.csv(tax_df_6, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/taxonomy_20240725_collapsed.csv")
```
...
write.csv(taxon_groups, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/taxon_groups.csv")
```
