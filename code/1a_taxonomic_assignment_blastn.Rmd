...
- this is the fasta seqs from the 20240703 run on dadasnake (i.e. duplicate sbs2022 libraries separated), and blastn using a ncbi nt database accessed on 2024-07-18 with 98% seq identity and 98% query coverage   
```{r load-output-from-taxonkit}
taxonomy <-read.delim("/home/kimberly.ledger/BeringSea_Arctic_eDNA/data/NBS_SBS_DBO_20240806/blastn_taxlineage_98.txt", header = FALSE, na.strings=c(""," ","NA"))
...
## REMOVED : going with a 0.5% similarity threshold
```{r}
...
```{r}
#write.csv(tax_df_4, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/tax_df_20240806.csv")
```
...
fasta_file <- "/home/kimberly.ledger/BeringSea_Arctic_eDNA/data/NBS_SBS_DBO_20240806/filtered.seqs.fasta"
output_file <- "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/gadidae.fasta"
...
# Define the input and output file paths
fasta_file <- "/home/kimberly.ledger/BeringSea_Arctic_eDNA/data/NBS_SBS_DBO_20240806/filtered.seqs.fasta"
output_file <- "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/oncorhynchus.fasta"
...
```{r}
salmon_custom <- read.csv("/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/oncorhynchus_asv_id.csv") %>%
  select(!X)
...
looks like the 0.5% threshold does more to help than the custom reference db for salmon

```{r}
gadidae_custom <- read.csv("/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/gadidae_asv_id.csv") %>%
  select(!X)
...
write.csv(sebastidae, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/sebastidae_pre.csv", row.names = F)
```
...
#export to make custom groups 
write.csv(pleuronectidae, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/pleuronectidae_pre.csv", row.names = F)
```
...
#export to make custom groups 
write.csv(cottidae, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/cottidae_pre.csv", row.names = F)
```
...
write.csv(remaining, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/remaining_pre.csv", row.names = F)
```


read back in taxonomic groups
```{r}
sebastidae_post <- read.csv("/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/sebastidae_post.csv")
pleuronectidae_post <- read.csv("/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/pleuronectidae_post.csv")
cottidae_post <- read.csv("/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/cottidae_post.csv")
remaining_post <- read.csv("/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/remaining_post.csv")
```
...
```{r}
write.csv(tax_df_5, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/taxonomy_20240806_uncollapsed.csv")
write.csv(tax_df_6, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/taxonomy_20240806_collapsed.csv")
```
...
write.csv(taxon_groups, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/taxon_groups.csv")
```
