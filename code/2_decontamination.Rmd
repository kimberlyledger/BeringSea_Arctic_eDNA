...
```{r}
asv_table <- readRDS("/home/kimberly.ledger/BeringSea_Arctic_eDNA/data/NBS_SBS_DBO_20240806/filtered.seqTab.RDS") %>%
  select(!Row.names)
...
```{r}
taxonomy <- read.csv("/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/taxonomy_20240806_collapsed.csv") %>%
  select(!X) %>%
  rename(ASV = qseqid)
```
...
```{r}
write.csv(asv_table_filter4, "/home/kimberly.ledger/BeringSea_Arctic_eDNA/outputs/20240806/decontaminated_asv_table.csv")
```
